...
module ElVfs
  describe FilesController do
    ...
    def valid_attributes
      { :entry_name => 'file.txt', :parent_id => Entry.root }
    end
    ...
    describe "GET new" do
      it "assigns a new file as @file" do
        get :new
        assigns(:file).should be_a_new(ElVfs::File)
      end
    end
    ...
    describe "POST create" do
      ...
      describe "with invalid params" do
        it "assigns a newly created but unsaved file as @file" do
          ...
          ElVfs::File.any_instance.stub(:save).and_return(false)
          post :create, :file => {}
          assigns(:file).should be_a_new(ElVfs::File)
        end
    ...
    describe "PUT update" do
      describe "with valid params" do
        it "updates the requested file" do
          file = ElVfs::File.create! valid_attributes
          # Assuming there are no other files in the database, this
          # specifies that the ElVfs::File created on the previous line
          # receives the :update_attributes message with whatever params are
          # submitted in the request.
          ElVfs::File.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
